...
kubectl exec -n "$OPENCLAW_NAMESPACE" deploy/gateway -- sh -c \
  ...
  --fallbacks "google/gemini-3.5-flash,openrouter/nvidia/nemotron-3-nano-30b-a3b:free" \
  --timeout-seconds 600 \
  --no-deliver'
```
